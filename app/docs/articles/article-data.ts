...
export const androidModuleDetails = [
  ...
  {
    name: "FreeLook",
    description: "Freely moves your third-person camera while keeping player rotation locked.",
  ...
  },
  {
    ...
    description: "Quickly switches to third person so you can check behind you.",
  ...
  {
    name: "Quick Drop",
    description: "Drops one item from your selected hotbar slot with a shortcut tap.",
    icon: "/mod-icons/down.png",
    settingsCount: 0,
    category: "Movement",
    source: "QuickDrop",
  },
  {
    name: "Zoom",
    description: "Zooms the camera with configurable field of view and speed.",
  ...
  {
    name: "Motion Blur",
    description: "Adds a previous-frame ghosting pass for smoother motion.",
  ...
  },
  {
    ...
    description: "Renders your own nametag while in third person.",
  ...
  {
    name: "View Model",
    description: "Adjusts how the held item appears in first person.",
  ...
  {
    name: "Arrow Counter",
    description: "Counts arrows in your inventory.",
  ...
  {
    name: "Coordinates",
    description: "Displays customizable coordinate readouts.",
  ...
  {
    name: "Direction HUD",
    description: "Displays a movable direction strip.",
  ...
  {
    name: "Hardware Stats",
    description: "Displays configurable memory and CPU information for the Android device.",
  ...
  {
    name: "Pot Counter",
    description: "Counts splash potions in your inventory.",
  ...
  {
    name: "Tab List",
    description: "Shows players in the current world.",
